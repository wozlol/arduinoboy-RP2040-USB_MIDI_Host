...
void modeLSDJSlaveSync()
{
  ...
  #ifdef USE_RP2040
  // modeLSDJSlaveSyncUsbMidiReceive() above has no RP2040 branch (Teensy/Leonardo only),
  // so without this, incoming USB-device sysex - including a web/Max programmer's request
